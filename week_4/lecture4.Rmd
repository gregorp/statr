...
A data point is influential when it has both a high leverage and a big residual. **Cook's Distance** or **Cook's D** is a nice overall measurement of how much a single observation effects the overall fit. You can calculate Cook's D for every point in a `glm` or `lm` with  `cooks.distance()`. Automatically calculated by `broom::augment`.
